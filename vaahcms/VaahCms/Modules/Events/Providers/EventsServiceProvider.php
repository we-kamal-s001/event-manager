<?php namespace VaahCms\Modules\Events\Providers;


use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use VaahCms\Modules\Events\Providers\RouteServiceProvider;
use VaahCms\Modules\Events\Providers\EventServiceProvider;
...
class EventsServiceProvider extends ServiceProvider
{
    ...
    private function registerMiddleware($router) {
        ...
        //register middleware
        //$router->aliasMiddleware('sample.middleware', \Events\Http\Middleware\SampleMiddleware::class);
    ...
    {
        $viewPath = resource_path('/views/vaahcms/modules/events');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/views/vaahcms/modules/events';
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/modules/events/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/modules/events');
