            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-none"
                                 data-testid="managers-filters-sort-none"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-ascending"
                                 data-testid="managers-filters-sort-ascending"
                                 value="updated_at"
                                 v-model="store.query.filter.sort" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-descending"
                                 data-testid="managers-filters-sort-descending"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-false"
                                 data-testid="managers-filters-active-false"
                                 value="false"
                                 v-model="store.query.filter.is_active" />
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-exclude"
                                 data-testid="managers-filters-trashed-exclude"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-include"
                                 data-testid="managers-filters-trashed-include"
                                 value="include"
                                 v-model="store.query.filter.trashed" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-only"
                                 data-testid="managers-filters-trashed-only"
                                 value="only"
                                 v-model="store.query.filter.trashed" />
