        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="managers-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="managers-actions-bulk-menu"
                    aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="managers-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="managers-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                type="button"
                                class="p-button-sm"
                                data-testid="managers-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="managers-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
