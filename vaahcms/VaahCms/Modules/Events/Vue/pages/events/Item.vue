            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    <Button label="Edit"
                            ...
                            data-testid="events-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="events-item-to-list"
                            @click="store.toList()"/>
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="events-item-restore"
...
<!--                        </template>-->
                        ...
                        <template v-else-if="column === 'managers'">
                            <VhViewRow :label="null"
                                       :value="null"
