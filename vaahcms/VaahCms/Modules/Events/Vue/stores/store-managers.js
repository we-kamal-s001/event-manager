...
let model_namespace = 'VaahCms\\Modules\\Events\\Models\\Manager';


let base_url = document.getElementsByTagName('base')[0].getAttribute("href");
let ajax_url = base_url + "/events/managers";
...
export const useManagerStore = defineStore({
    ...
    actions: {
        ...
        toForm()
        {
            this.item = vaah().clone(this.assets.empty_item);
            this.getFormMenu();
            this.$router.push({name: 'managers.form'})
        },
        //---------------------------------------------------------------------
        toView(item)
        {
...
// Pinia hot reload
if (import.meta.hot) {
    import.meta.hot.accept(acceptHMRUpdate(useManagerStore, import.meta.hot))
}
