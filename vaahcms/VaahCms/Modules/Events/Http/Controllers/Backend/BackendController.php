...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-events';
        ...
        */
        ...
        return view('events::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('events.name'),
            'version' => config('settings.global.events_version')??config('events.version'),
            'is_dev' => config('events.is_dev'),
        ];
